...
function buildVdoPushLink(input){
  ...
  // &quality=0 zielt direkt auf 1080p, &lowlatency reduziert Puffer/Jitter-Verzögerung
  return `https://vdo.ninja/?push=${encodeURIComponent(id)}&webcam&quality=0&lowlatency`;
}
